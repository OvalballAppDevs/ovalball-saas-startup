...
begin
  foreach v_person in array array[v_full, v_access, v_readonly, v_admin, v_other_admin, v_fs, v_ta, v_member] loop
    ...
    insert into public.profiles (id, first_name, surname, email, date_of_birth) values (v_person, 'Rac', 'Tester', 'rac-' || v_person::text || '@ovalball.test', (current_date - interval '35 years')::date)
